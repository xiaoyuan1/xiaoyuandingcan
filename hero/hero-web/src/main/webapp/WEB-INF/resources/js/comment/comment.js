...
Ext.define('comment.CommentModel', {
...
commentGrid.getSelectionModel().on('selectionchange',
		function(selModel, selections) {
			commentGrid.down('#delete').setDisabled(selections.length === 0);
		});
...
var commentdForm = new Ext.form.FormPanel({
			title : '信息查询',
			width : 200,
			height : 200,
			frame : true,
